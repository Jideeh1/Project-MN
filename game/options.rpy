...
define config.name = _("Memoria Nostra")
...
define build.name = "MemoriaNostra"
...
define config.end_splash_transition = Fade(1,0,2)
...
define config.after_load_transition = Fade(1,0,2)


## Used when entering the main menu after the game has ended.

define config.end_game_transition = Fade(1,0,2)
...
define config.save_directory = "MemoriaNostra-1717394714"
...
define config.mouse = {
    'default': [
        ( 'mouseup_1', lambda *args: play_click_sound() )
    ]
}
